...
/**
 * Onboarding Screen 3: Interstitial
 * Transition screen with stylized verse display
 */
export default function OnboardingInterstitial1Screen() {
  ...
  useEffect(() => {
    trackOnboardingStepViewed(3, 'interstitial_1');
  }, []);
      ...
      >
        <View style={styles.content}>
          ...
          <Animated.Text style={[styles.tagline, { opacity: taglineOpacity }]}>
            God's Word has something for{'\n'}
            exactly where you are.
          </Animated.Text>

          {/* Subline - fades in after tagline */}
...
const styles = StyleSheet.create({
  ...
  subline: {
    ...
    color: '#6a2e41', // Burgundy to match attribution
    textAlign: 'center',
